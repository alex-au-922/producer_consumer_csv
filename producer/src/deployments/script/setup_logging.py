...
def setup_logging() -> None:
    ...
    stream_handler.setFormatter(logging.Formatter(LoggingConfig.LOG_FORMAT, datefmt = LoggingConfig.LOG_DATE_FORMAT))
    ...
    if LOG_LEVEL_INT is not None and LOG_LEVEL_INT <= logging.INFO:
        ...
        info_handler.setFormatter(logging.Formatter(LoggingConfig.LOG_FORMAT, datefmt = LoggingConfig.LOG_DATE_FORMAT))
    ...
    if LOG_LEVEL_INT is not None and LOG_LEVEL_INT <= logging.WARNING:
        ...
        warning_handler.setFormatter(logging.Formatter(LoggingConfig.LOG_FORMAT, datefmt = LoggingConfig.LOG_DATE_FORMAT))
    ...
    if LOG_LEVEL_INT is not None and LOG_LEVEL_INT <= logging.ERROR:
        ...
        error_handler.setFormatter(logging.Formatter(LoggingConfig.LOG_FORMAT, datefmt = LoggingConfig.LOG_DATE_FORMAT))
